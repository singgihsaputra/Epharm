					...
					<li >
                        ...
                        <li>
                            <a href="pemesanan.php">
								...
								$not2=mysql_query("SELECT count(distinct id_transaksi) as jml from transaksi where status='1'");
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
										<?php 
										$show=mysql_query("SELECT DISTINCT * from transaksi where status='4' or status='3' GROUP BY id_supplier");
										$i=0;
